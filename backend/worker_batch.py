...
def _prompt_knowledge_seed(utterance: dict) -> str:
    return (
        ...
        # "- 話し方や雰囲気の説明\n"
        # "- 発話意図の説明\n\n"
        # "以下の形式のうち、いずれかを選んで整形した上で出力してください：\n"
        # "- AとはBである\n"
        # "- AするとBになる\n"
        # "- 〜すべき\n"
        # "- 〜するとよい\n"
        # "- 〜するには、まず〜\n\n"
        "From the following text, extract content that matches the conditions listed below,\n"
        "and enumerate the results in Japanese, separated by the delimiter line \"---\".\n"
        "If no applicable content is found, output nothing.\n\n"
        "Extraction criteria:\n"
        "- Content describing a specific action, concept, or phenomenon that can be observed,\n"
        "  verified, or reproduced by a third party\n"
        "- Content that can be written with a noun or noun phrase as the subject\n\n"
        "Examples of extractable content:\n"
        "- Definitions (A is B)\n"
        "- Causal relationships (If A occurs, B happens)\n"
        "- Physical, technical, institutional, or procedural rules or guidelines\n"
        "  (should do / it is recommended to do)\n"
        "- Procedures or methods (To do X, first do Y)\n\n"
        "Exclude the following:\n"
        "- Items where the subject cannot be clearly identified\n"
        "- Content that cannot be used independently outside its original context\n"
        "- Guidelines about conversation, casual talk, or communication acts themselves\n"
        "- Advice on topic selection or how to conduct a conversation\n"
        "- Advice on psychological attitudes or emotional states\n"
        "- Content intended to explain the usage or capabilities of a specific individual,\n"
        "  system, or tool\n"
        "- Statements describing possibilities or scope of capability, such as\n"
        "  \"it can be analyzed if...\" or \"advice can be given if...\"\n\n"
        "The following are prohibited:\n"
        "- Rephrasing or paraphrasing\n"
        "- Explanations of the text\n"
        "- Descriptions of speaking style or tone\n"
        "- Explanations of the speaker's intent\n\n"
        "Format the output by choosing one of the following forms:\n"
        "- A is B\n"
        "- If A occurs, B happens\n"
        "- should do\n"
        ...
        for seed_body in seeds:
            ...
            conn.execute(
                ...
                INSERT INTO worker_jobs (
                  ...
                  'queued', 1, datetime('now'), datetime('now')
                )
                """,
